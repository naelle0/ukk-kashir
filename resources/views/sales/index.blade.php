                    ...
                    <div class="table-responsive">
                        <div class="row mb-3">
                            <div class="col-md-12 d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('sales.create') }}" class="btn btn-gray ml-2 p-2">
                                    Tambah Penjualan
                                </a>
                                @else 
                                <a href="{{ route('sales.export') }}" class="btn btn-gray ml-2 p-2">
                                    Export Excel
                                </a>                            
                                @endif
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-gray detail-transaction-btn" data-toggle="modal" data-target="#transactionDetailModal" data-transaction='{{ json_encode($item) }}'>Lihat</button>
                                        <a href="{{ route('sales.invoice', $item->id) }}" class="btn btn-gray">Unduh Bukti</a>
                                    </td>                        
                                </tr>
                                @endforeach
                            </tbody>
